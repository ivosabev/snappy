...
rm -rf "$STAGE" "$ROOT/SnapZones.app"
...
rm -rf "$INSTALL_APP" "/Applications/SnapZones.app"
...
echo ""
echo "First run / after rename: enable Snappy in System Settings → Privacy & Security → Accessibility."
echo "Remove any old SnapZones entries there."
